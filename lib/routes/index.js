    ...
    .exec((err, performers) => {
      ...
      .exec((err, performances) => {
        res.render('home', {
          ...
          subtitle: i18n.__('Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat'),
