...
userSchema.virtual('imagePath').get(function() {
  return '/storage/' + this.image + '/512/200';
});

userSchema.virtual('teaserImagePath').get(function() {
  return '/storage/' + this.teaserImage + '/1920/400';
});
...
userSchema.plugin(require('../plugins/elasticsearch/User'));
